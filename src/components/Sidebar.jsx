	...
	return (
		<aside className="2xl:w-64 bg-PlatformGrey rounded-lg overflow-hidden">
			...
			<footer className="border-t border-BorderGrey mt-6 pt-6 px-8 pb-8">
				<a 
					className="bg-transparent text-BrandGreenIgnite border border-BrandGreenIgnite rounded-lg h-14 font-bold flex items-center justify-center gap-1 hover:bg-BrandGreenIgnite hover:text-white transition duration-300 focus:outline outline-1 outline-BrandGreenIgnite"
					href="#"
				>
